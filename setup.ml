...
(* OASIS_START *)
(* DO NOT EDIT (digest: 5372eae72ea4f0eae10250181f4c6982) *)
(*
...
let setup_t =
  {
            ...
            [
               Flag
                 ({
                   ...
                   {
                      flag_description =
                        Some "Assume (or not) the availability of optiz3.";
               ...
               Library
                 ({
                   ...
                   {
                      lib_modules = ["ZZ3Optim"];
                      lib_pack = false;
                      lib_internal_modules = [];
                      lib_findlib_parent = Some "Z3overlay";
                      lib_findlib_name = Some "optim";
                      lib_findlib_containers = []
                   });
               Executable
                 ({
                  ...
                  },
                   {
                      bs_build =
                        [
                           ...
                           (OASISExpr.EAnd
                              (OASISExpr.EFlag "tests",
                                OASISExpr.EFlag "optim"),
                             true)
                        ];
                      bs_install = [(OASISExpr.EBool true, false)];
                      bs_path = "test";
                      bs_compiled_object = Best;
                      bs_build_depends = [InternalLibrary "Z3overlay_optim"];
                      bs_build_tools = [ExternalTool "ocamlbuild"];
                      bs_c_sources = [];
                      bs_data_files = [];
                      bs_ccopt = [(OASISExpr.EBool true, [])];
     ...
     oasis_version = "0.4.5";
     oasis_digest = Some "\014k\131l\b\029\187\182\154\001^\229V\b\198\224";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
